...
# Lets use Linaro GCC 7.2
TOOLCHAIN="$HOME/linaro/bin/arm-linaro-linux-androideabi-"

ARCHITECTURE="arm"

KERNEL_NAME="Zap-kernel"
...
if [ -e $KERNEL_IMAGE ]; then
	...
	echo -e $COLOR_GREEN"\n Zap-kernel for $KERNEL_VARIANT is baked... now goto '$RELEASE_DIR' folder...\n"$COLOR_NEUTRAL
else
